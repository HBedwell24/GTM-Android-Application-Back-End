...
class Functions{
	...
	public function registerUser($name, $email, $password) {
		...
		// if all fields are not empty on the registration page
		if (!empty($name) && !empty($email) && !empty($password)) {
			
			// if the user already exists in the database, error			
			...
			// if the user does not already exist in the database, insert new data
			else {
					
				$result = $db -> insertData($name, $email, $password);
					
				// if database operation was successful
				if ($result) {
				...
				// if database operations failed, error
				else {
		...
		// if at least one of the fields are empty on the registration page
		else {
